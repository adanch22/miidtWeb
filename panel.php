...
$demo = new panel();
$admin_id = $demo->getUser($_SESSION['admin_name']);
?>
            ...
            <div class="panel-group">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="line"></div>
                        <button type="button" id="optionDeleteStudent" class="btn btn-success btn-block disabled" data-toggle="modal">
                            <i class="fa fa-user-times"></i>&nbsp;Delete student</button>
                        <div class="line"></div>
                        ...
                        <div class="line"></div>
                        <button type="button" id="closeSession" class="btn btn-danger btn-block">
                            close session&nbsp;<i class="fa fa-sign-out"></i></button>
                    </div>
                </div>
            </div>
        </div>
