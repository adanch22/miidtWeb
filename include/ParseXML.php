    ...
    function getAllexercises($name_file){
        ...
        foreach($xml->exercise as $item){
            ...
            if($item->attributes()->$att == 'questionary')   {
                ...
                $exercise_c['exercise_type'] = 'Ejercicio tipo pregunta cerrada' ;


            }elseif ($item->attributes()->$att == 'presentation'){

                $exercise_c['exercise_type'] = 'Ejercicio tipo pregunta abierta con imagen' ;


            }elseif ($item->attributes()->$att == 'presentationm'){

                $exercise_c['exercise_type'] = 'Ejercicio tipo pregunta cerrada con imagen' ;
